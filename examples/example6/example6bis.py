...
"""
This is an example of a quasi-harmonic calculation for an hexagonal system using a quartic polynomial.
"""
...
if __name__ == "__main__":
    ...
    plot_Etot(celldmsx,Ex=None,n=(5,0,5),nmesh=(50,0,50),fittype="quartic",ibrav=4,a=a0+aT[iT])
    # 3D plot fitted energy and points
    plot_Etot(celldmsx,Ex+Fvib[iT],n=(5,0,5),nmesh=(50,0,50),fittype="quartic",ibrav=4,a=a0+aT[iT])
    # 3D plot with fitted energy Fvib only
    plot_Etot(celldmsx,Ex=None,n=(5,0,5),nmesh=(50,0,50),fittype="quartic",ibrav=4,a=aT[iT])
    # 2D contour plot with fitted energy (Etot+Fvib)
    plot_Etot_contour(celldmsx,nmesh=(50,0,50),fittype="quartic",ibrav=4,a=a0+aT[iT])
    # 2D contour plot with fitted energy Fvib only
    plot_Etot_contour(celldmsx,nmesh=(50,0,50),fittype="quartic",ibrav=4,a=aT[iT])   
